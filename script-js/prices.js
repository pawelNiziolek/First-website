...
htwo1.addEventListener('click', () => {
  tf1.classList.toggle('vis') ? spantf1.textContent = "cennik-" : spantf1.textContent = "cennik+";
})
htwo2.addEventListener('click', () => {
  tf2.classList.toggle('vis') ? spantf2.textContent = "cennik-" : spantf2.textContent = "cennik+";
})
htwo3.addEventListener('click', () => {
  tf3.classList.toggle('vis') ? spantf3.textContent = "cennik-" : spantf3.textContent = "cennik+";
})
htwo4.addEventListener('click', () => {
  tf4.classList.toggle('vis') ? spantf4.textContent = "cennik-" : spantf4.textContent = "cennik+";
})
htwo5.addEventListener('click', () => {
  tf5.classList.toggle('vis') ? spantf5.textContent = "cennik-" : spantf5.textContent = "cennik+";
})
htwo6.addEventListener('click', () => {
  tk1.classList.toggle('vis') ? spantk1.textContent = "cennik-" : spantk1.textContent = "cennik+";
})
htwo7.addEventListener('click', () => {
  tm1.classList.toggle('vis') ? spantm1.textContent = "cennik-" : spantm1.textContent = "cennik+";
})
htwo8.addEventListener('click', () => {
  tm2.classList.toggle('vis') ? spantm2.textContent = "cennik-" : spantm2.textContent = "cennik+";
})
htwo9.addEventListener('click', () => {
  tm3.classList.toggle('vis') ? spantm3.textContent = "cennik-" : spantm3.textContent = "cennik+";
})
// htwo10.addEventListener('click', () => {
//   tp1.classList.toggle('vis') ? spantp1.textContent = "cennik-" : spantp1.textContent = "cennik+";
// })
htwo11.addEventListener('click', () => {
  tp2.classList.toggle('vis') ? spantp2.textContent = "cennik-" : spantp2.textContent = "cennik+";
})
htwo12.addEventListener('click', () => {
  tp3.classList.toggle('vis') ? spantp3.textContent = "cennik-" : spantp3.textContent = "cennik+";
})
htwo13.addEventListener('click', () => {
  tp4.classList.toggle('vis') ? spantp4.textContent = "cennik-" : spantp4.textContent = "cennik+";
})
htwo14.addEventListener('click', () => {
  tp5.classList.toggle('vis') ? spantp5.textContent = "cennik-" : spantp5.textContent = "cennik+";
})
htwo15.addEventListener('click', () => {
  tp6.classList.toggle('vis') ? spantp6.textContent = "cennik-" : spantp6.textContent = "cennik+";
})
htwo16.addEventListener('click', () => {
  tfo1.classList.toggle('vis') ? spantfo1.textContent = "cennik-" : spantfo1.textContent = "cennik+";
})
htwo17.addEventListener('click', () => {
  tfo2.classList.toggle('vis') ? spantfo2.textContent = "cennik-" : spantfo2.textContent = "cennik+";
})
htwo18.addEventListener('click', () => {
  tfo3.classList.toggle('vis') ? spantfo3.textContent = "cennik-" : spantfo3.textContent = "cennik+";
})
htwo19.addEventListener('click', () => {
  tpw1.classList.toggle('vis') ? spantpw1.textContent = "cennik-" : spantpw1.textContent = "cennik+";
})
htwo20.addEventListener('click', () => {
  twos1.classList.toggle('vis') ? spantwos1.textContent = "cennik-" : spantwos1.textContent = "cennik+";
})
htwo21.addEventListener('click', () => {
  tre1.classList.toggle('vis') ? spantre1.textContent = "cennik-" : spantre1.textContent = "cennik+";
})
htwo22.addEventListener('click', () => {
  tre2.classList.toggle('vis') ? spantre2.textContent = "cennik-" : spantre2.textContent = "cennik+";
})
htwo23.addEventListener('click', () => {
  tre3.classList.toggle('vis') ? spantre3.textContent = "cennik-" : spantre3.textContent = "cennik+";
})

htwo24.addEventListener('click', () => {
  tre4.classList.toggle('vis') ? spantre4.textContent = "cennik-" : spantre4.textContent = "cennik+";
})
htwo25.addEventListener('click', () => {
  tu1.classList.toggle('vis') ? spantu1.textContent = "cennik-" : spantu1.textContent = "cennik+";
})
htwo26.addEventListener('click', () => {
  tu2.classList.toggle('vis') ? spantu2.textContent = "cennik-" : spantu2.textContent = "cennik+";
})
htwo27.addEventListener('click', () => {
  tfr1.classList.toggle('vis') ? spantfr1.textContent = "cennik-" : spantfr1.textContent = "cennik+";
})
htwo28.addEventListener('click', () => {
  tfr2.classList.toggle('vis') ? spantfr2.textContent = "cennik-" : spantfr2.textContent = "cennik+";
})
htwo29.addEventListener('click', () => {
  tfr3.classList.toggle('vis') ? spantfr3.textContent = "cennik-" : spantfr3.textContent = "cennik+";
})
htwo30.addEventListener('click', () => {
  tfr4.classList.toggle('vis') ? spantfr4.textContent = "cennik-" : spantfr4.textContent = "cennik+";
})
htwo31.addEventListener('click', () => {
  tfr5.classList.toggle('vis') ? spantfr5.textContent = "cennik-" : spantfr5.textContent = "cennik+";
})
htwo32.addEventListener('click', () => {
  tbr1.classList.toggle('vis') ? spantbr1.textContent = "cennik-" : spantbr1.textContent = "cennik+";
})
htwo33.addEventListener('click', () => {
  tma1.classList.toggle('vis') ? spantma1.textContent = "cennik-" : spantma1.textContent = "cennik+";
})
htwo34.addEventListener('click', () => {
  tma2.classList.toggle('vis') ? spantma2.textContent = "cennik-" : spantma2.textContent = "cennik+";
})
htwo35.addEventListener('click', () => {
  tma3.classList.toggle('vis') ? spantma3.textContent = "cennik-" : spantma3.textContent = "cennik+";
})
htwo36.addEventListener('click', () => {
  tdl1.classList.toggle('vis') ? spantf1.textContent = "cennik-" : spantdl1.textContent = "cennik+";
})
htwo37.addEventListener('click', () => {
  tlr1.classList.toggle('vis') ? spantlr1.textContent = "cennik-" : spantlr1.textContent = "cennik+";
})
htwo38.addEventListener('click', () => {
  tdm1.classList.toggle('vis') ? spantdm1.textContent = "cennik-" : spantdm1.textContent = "cennik+";
})